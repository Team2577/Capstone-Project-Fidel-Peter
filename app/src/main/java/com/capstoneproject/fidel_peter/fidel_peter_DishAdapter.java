...
public class fidel_peter_DishAdapter extends RecyclerView.Adapter<fidel_peter_DishAdapter.MyViewHolder> {
    Context context;
    ArrayList<fidel_peter_Restaurant>restaurants;

    public fidel_peter_DishAdapter(Context context, ArrayList<fidel_peter_Restaurant> restaurants) {
    ...
    @NonNull
    @Override
    public fidel_peter_DishAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.layoutRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, fidel_peter_OrderActivity.class);
