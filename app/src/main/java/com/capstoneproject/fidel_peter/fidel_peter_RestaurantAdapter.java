...
public class fidel_peter_RestaurantAdapter extends RecyclerView.Adapter<fidel_peter_RestaurantAdapter.MyViewHolder> {
    Context context;
    ArrayList<fidel_peter_Restaurant>restaurants;

    public fidel_peter_RestaurantAdapter(Context context, ArrayList<fidel_peter_Restaurant> restaurants) {
    ...
    @NonNull
    @Override
    public fidel_peter_RestaurantAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.layoutRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, fidel_peter_CuisineActivity.class);
